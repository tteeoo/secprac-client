...
wget https://github.com/blueberry-jam/secprac-client/releases/download/0.1.4/secprac-client https://raw.githubusercontent.com/blueberry-jam/secprac-client/master/data/secprac-start
